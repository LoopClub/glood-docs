---
title: How to create Slot Based Recommendation section
---
...
- Choose the experience type and give the section a title (e.g., Featured Products)
- Under **Select Recommendation Type**, choose **Slot Based** to create customized recommendation slots
...
- After selecting Slot Based as your recommendation type and filling out the necessary details, click on the Save button
- This will create the section and open the section detail page
- **Note:** The section is disabled by default until you enable it
<img src="/images/section-setup-28.png" alt="Section Detail Page" />


#### 5. Configure Your Section (Section Detail Page)
→ Once saved, you'll be redirected to the Section Detail Page:
<img src="/images/section-setup-29.png" alt="Section Detail Page Configuration" />
...
If you need help with setting up or customizing Slot Based Recommendation sections, contact our support team at support@glood.ai
