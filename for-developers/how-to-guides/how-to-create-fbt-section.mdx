...
- Enable this to let the system automatically suggest products based on your store’s real-time sales data using proprietary algorithms.
- Best for effortless, data-driven suggestions.
...
**4. Advanced Configuration (Expandable)**
...
Choose where on your product page this recommendation section will appear.
...
**→ Visual Editor**
- Access powerful visual editing tools to customize the section's appearance
- Click the visual editor button to open an intuitive interface for:
...
- Available targeting options:
  ...
  - First-time visitors
  - Returning visitors 
  - Buyers (made a purchase in current session)
  - Is customer (has previous orders)
  - Is not customer (no previous orders)
- Helps create personalized experiences for different user segments
- Multiple segments can be selected to show the section to various groups
