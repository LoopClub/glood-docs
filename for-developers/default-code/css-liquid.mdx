...
[data-gai-section-id="{{ section_id }}"] ._gai-prod-prc { 
  ...
  font-family: {{ settings.breakpoints.small.price_font_size }}; 
}
...
{% if product_card_settings.disable_add_to_cart_button %}
  [data-gai-section-id="{{ section_id }}"] {
    ._gai-atc-btn {
...
@media (min-width: {{ settings.breakpoints.medium.screen_size |  default: 768 }}px) { 
  ...
  [data-gai-section-id="{{ section_id }}"] ._gai-grid { 
    ...
    gap: {{ settings.breakpoints.medium.gutter |  default: 10 }}px; 
  }

  [data-gai-section-id="{{ section_id }}"] ._gai-prod-prc { 
    font-family: {{ settings.breakpoints.medium.price_font_size }}; 
  }
...
@media (min-width: {{ settings.breakpoints.large.screen_size |  default: 1024 }}px) { 
  ...
  [data-gai-section-id="{{ section_id }}"] ._gai-grid { 
    grid-template-columns: repeat({{- settings.breakpoints.large.cards_per_view -}},1fr); 
    gap: {{ settings.breakpoints.large.gutter |  default: 10 }}px; 
  }

  [data-gai-section-id="{{ section_id }}"] ._gai-prod-prc { 
    font-family: {{ settings.breakpoints.large.price_font_size }}; 
  }
